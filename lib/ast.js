...
(Node = function(){
  ...
  carp: function(it){
    throw SyntaxError(it + " on line " + this.getLine());
  },
  getLine: function(){
    return this.line || this.traverseChildren(function(it){
      return it.line;
    });
  },
...
exports.Block = Block = (function(_super){
  ...
  prototype.compile = function(o, level){
    var code, tab, i, node, that, _ref, _len;
    ...
    for (i = 0, _len = (_ref = this.lines).length; i < _len; ++i) {
      ...
      if (that = constructor.lineno && node.getLine()) {
        code += "/*" + that + "*/";
      }
  ...
  prototype.compileRoot = function(options){
    ...
    delete o.filename;
    Block.lineno = o.lineno, delete o.lineno;
