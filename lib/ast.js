...
exports.SoftImport = SoftImport = (function(superclass){
  SoftImport.displayName = 'SoftImport';
  var prototype = __extend(SoftImport, superclass).prototype, constructor = SoftImport;
  function SoftImport(left, right, all){
    var __this = this instanceof __ctor ? this : new __ctor;
    __this.left = left;
    __this.right = right;
    __this.all = all && 'All';
  ...
  prototype.compileNode = function(o){
    ...
    return Call.make(Util("softImport" + (this.all || '')), [this.left, right]).compileNode(o);
  };
  prototype.compileAssign = function(o, items){
    var top, reft, left, delim, space, code, i, node, com, logic, dyna, key, val, __ref, __len;
    if (!items.length) {
    ...
    for (i = 0, __len = items.length; i < __len; ++i) {
      ...
      if (node instanceof Splat) {
        code += SoftImport(reft, node.it).compile(o);
        continue;
      }
      if (logic = node.getDefault()) {
        node = node.first;
...
UTILITIES = {
  ...
  softImport: 'function(obj, src){\n  var own = {}.hasOwnProperty;\n  for (var key in src) if (own.call(src, key) && !own.call(obj, key)) obj[key] = src[key];\n  return obj;\n}',
  importAll: 'function(obj, src){\n  for (var key in src) obj[key] = src[key];\n  return obj;\n}',
  softImportAll: 'function(obj, src){\n  for (var key in src) obj[key] || (obj[key] = src[key]);\n  return obj;\n}',
  repeatString: 'function(str, n){\n  for (var r = \'\'; n > 0; (n >>= 1) && (str += str)) if (n & 1) r += str;\n  return r;\n}',
  repeatArray: 'function(arr, n){\n  for (var r = []; n > 0; (n >>= 1) && (arr = arr.concat(arr)))\n    if (n & 1) r.push.apply(r, arr);\n  return r;\n}',
  of: 'function(x, arr){\n  var i = 0, l = arr.length >>> 0;\n  while (i < l) if (x === arr[i++]) return true;\n  return false;\n}',
  out: '(typeof exports != \'undefined\' && exports) || (typeof script != \'undefined\' && script) || this || {}',
  split: "''.split",
  replace: "''.replace",
  toString: '{}.toString',
  join: '[].join',
