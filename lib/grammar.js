...
bnf = {
  Head: [
    o('ID', function(){
      ...
      return L(Literal($1));
    }), o('LITERAL', ditto), o('Parenthetical'), o('List'), o('PARAM( ArgList )PARAM -> Block', function(){
      return L(Fun($2, $5, $4 === '~>'));
    }), o('FUNCTION CALL( ArgList )CALL Block', function(){
      return L(Fun($3, $5).named($1));
    ...
    }), o('LET CALL( ArgList )CALL Block', function(){
      return Call['let']($3, $5);
  ...
  Chain: [
    ...
    }), o('Chain DOT List', ditto), o('Chain CALL( ArgList )CALL', function(){
      return $1.add(Call($3));
    }), o('Chain ?', function(){
  ...
  List: [
    o('[ ArgList  ]', function(){
      ...
      return L(Obj($2));
    }), o('[ ArgList  ] LABEL', function(){
      return L(Arr($2)).named($4);
    }), o('{ PropList } LABEL', function(){
      return L(Obj($2)).named($4);
    })
  ],
  ...
  Args: [
    o('Arg', function(){
      ...
      $1.push($3);
      return $1;
    }), o('Args OptComma NEWLINE Arg', function(){
      $1.push($4);
      return $1;
    }), o('INDENT Args OptComma DEDENT', function(){
      return $2;
    }), o('Args , INDENT Args OptComma DEDENT', function(){
      return $1.concat($4);
    })
  ],
  Arg: [
  ...
  Line: [
    ...
    }), o('PARAM( ArgList )PARAM <- Expression', function(){
      return Call.back($2, $5, $4 === '<~');
    }), o('COMMENT', function(){
  ...
  Expression: [
    o('Chain', function(){
    ...
    }), o('Chain ASSIGN INDENT ArgList DEDENT', function(){
      return Assign($1.unwrap(), Arr.maybe($4), $2);
    }), o('Expression IMPORT Expression', function(){
      return Import($1, $3, $2 === '<<<<');
    }), o('Expression IMPORT INDENT ArgList DEDENT', function(){
      ...
      prec: 'UNARY'
    }), o('UNARY INDENT ArgList DEDENT', function(){
      ...
      return Jump[$1]($2);
    }), o('HURL INDENT ArgList DEDENT', function(){
    ...
    }), o('LABEL Block', ditto), o('DECL INDENT ArgList DEDENT', function(){
  ...
  KeyValue: [
    o('Key'), o('LITERAL', function(){
      ...
      return Prop(L(Key($4)), L(Obj($2).named($4)));
    }), o('[ ArgList  ] LABEL', function(){
      return Prop(L(Key($4)), L(Arr($2).named($4)));
    })
  ],
  Prop: [
    o('Key : Expression', function(){
      return Prop($1, $3);
    }), o('Key : INDENT ArgList DEDENT', function(){
  ...
  Props: [
    o('Prop', function(){
      return [$1];
    }), o('Props , Prop', function(){
      $1.push($3);
      return $1;
    }), o('Props OptComma NEWLINE Prop', function(){
      $1.push($4);
      return $1;
    }), o('INDENT Props OptComma DEDENT', function(){
      return $2;
    })
  ],
