...
bnf = {
  ...
  Expression: [
    ...
    }), o('Expression SOFTIMPORT Expression', function(){
      return SoftImport($1, $3, $2 === '<<<<?');
    }), o('Expression SOFTIMPORT INDENT ArgList OptComma DEDENT', function(){
      return SoftImport($1, Arr.maybe($4), $2 === '<<<<?');
...
operators = [['left', '=>', 'POST_IF', 'FOR', 'WHILE'], ['right', ',', 'ASSIGN', 'HURL', 'EXTENDS', 'INDENT', 'SWITCH', 'CASE', 'TO', 'BY', 'LABEL'], ['right', 'LOGIC'], ['left', '^', 'BITWISE'], ['right', 'COMPARE'], ['left', 'RELATION'], ['left', 'SHIFT', 'IMPORT', 'SOFTIMPORT'], ['left', '+-'], ['left', 'MATH'], ['right', 'UNARY'], ['nonassoc', 'CREMENT']];
tokens = (function(){
